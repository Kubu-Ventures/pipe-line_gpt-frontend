    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#edeff0', fontFamily: F }}>
      ...
      <main style={{ flex: 1 }}>
        <div className="page-content" style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          {/* ── Filter bar ── */}
          <div className="brand-card filter-bar" style={{ background: '#FFFFFF', border: '1px solid #d4d6d8', borderRadius: 6, padding: '16px 20px', marginBottom: 8, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
          ...
          {/* ── Immutability notice ── */}
          <div className="brand-card" style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 16px', background: '#E8F0F9', border: '1px solid rgba(0,93,170,0.2)', borderRadius: 4, marginBottom: 8, fontSize: 12, color: '#006eb5' }}>
          ...
          {/* ── Event list ── */}
          <div className="brand-card" style={{ background: '#FFFFFF', border: '1px solid #d4d6d8', borderRadius: 6, overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
