...
const MOCK_AUDIT: AuditEvent[] = [
  ...
  },
  {
    ...
    actor_id: 'eng.sarah@example.com', target_id: 'response-88', target_type: 'response',
  ...
  },
  {
    ...
    actor_id: 'op.james@example.com', target_id: 'query-1284', target_type: 'query',
  ...
  },
  {
    ...
    actor_id: 'eng.sarah@example.com', target_id: 'response-87', target_type: 'response',
  ...
  },
  {
    ...
    actor_id: 'eng.sarah@example.com', target_id: 'query-1283', target_type: 'query',
  ...
  },
  {
    ...
    actor_id: 'admin@example.com', target_id: 'doc-342', target_type: 'document',
  ...
  },
  {
    ...
    actor_id: 'eng.marcus@example.com', target_id: 'response-86', target_type: 'response',
  ...
  },
  {
    ...
    actor_id: 'eng.sarah@example.com', target_id: 'doc-341', target_type: 'document',
  ...
  },
  {
    ...
    actor_id: 'op.james@example.com', target_id: 'user-12', target_type: 'user',
  ...
  },
  {
    ...
    actor_id: 'admin@example.com', target_id: 'prompt-v3', target_type: 'prompt_template',
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#F2F4F7', fontFamily: F }}>
      ...
      <main style={{ flex: 1 }}>
        <div className="page-content" style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          {/* ── Filter bar ── */}
          <div className="brand-card filter-bar" style={{ background: '#FFFFFF', border: '1px solid #E4E8EF', borderRadius: 6, padding: '16px 20px', marginBottom: 8, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
          ...
          {/* ── Immutability notice ── */}
          <div className="brand-card" style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 16px', background: '#E8F0F9', border: '1px solid rgba(0,93,170,0.2)', borderRadius: 4, marginBottom: 8, fontSize: 12, color: '#005DAA' }}>
          ...
          {/* ── Event list ── */}
          <div className="brand-card" style={{ background: '#FFFFFF', border: '1px solid #E4E8EF', borderRadius: 6, overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
