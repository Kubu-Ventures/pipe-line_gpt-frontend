      ...
      <main style={{ flex: 1 }}>
        <div className="page-content" style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          <div className="grid-2col" style={{ marginBottom: 24 }}>
            ...
            <div className="brand-card chart-panel" style={{ background: '#FFFFFF', border: '1px solid #E4E8EF', borderRadius: 6, padding: '24px 28px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          ...
          <div className="grid-3-2">
            ...
            <div className="brand-card" style={{ background: '#FFFFFF', border: '1px solid #E4E8EF', borderRadius: 6, overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
            ...
            <div id="deadlines" className="brand-card" style={{ background: '#FFFFFF', border: '1px solid #E4E8EF', borderRadius: 6, overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
