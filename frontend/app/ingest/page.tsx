    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#FFFFFF' }}>
      ...
      <main style={{ flex: 1 }}>
        <div className="page-content-md" style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          {/* History table */}
          <div className="brand-card" style={{ background: '#FFFFFF', border: '1px solid #E4E8EF', borderRadius: '6px', overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', marginTop: 8 }}>
