...
/* Brand fonts: Inter (or system sans-serif) — clean and corporate */
...
export default function HomePage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F2F4F7', fontFamily: F }}>
      ...
      {/* ── Hero — brand dark navy, white text, brand blue accent ── */}
      <section style={{
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <p style={{
            ...
            color: '#5B9BD4',        /* brand blue tint — not E4C teal */
            marginBottom: 16,
          }}>
      ...
      <main style={{ maxWidth: 900, margin: '0 auto', padding: '48px 32px 64px' }}>
        <form onSubmit={handleBegin}>
          ...
          {/* Info box — brand blue left border */}
          <div style={{
            background: '#E8F0F9',
            ...
            {[
              ...
              <p key={item} style={{
                fontFamily: F, fontSize: 14,
                color: '#1A3A5C',      /* brand dark blue text, not E4C teal */
          ...
          {/* CTA — dotted border, brand dark navy */}
          <button
            type="submit"
            disabled={!canSubmit}
            style={{
        ...
        <p style={{
          ...
          PipelineGPT is a prototype submitted for the PipelineGPT PipelineGPT Award
